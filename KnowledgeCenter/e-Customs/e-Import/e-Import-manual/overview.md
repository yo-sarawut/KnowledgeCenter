...
### รหัสสกุลเงินตรา (Currency Code)** ให้บันทึกค่าดังนี้
...
###อัตราแลกเปลี่ยนเงินตรา (Exchange Rate)** ให้บันทึกค่า ดังนี้ 
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTIwNTY1MTU5NSwtMTQ5NzQ5MDIwLC0xOT
