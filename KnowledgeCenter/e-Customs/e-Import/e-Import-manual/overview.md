...
### เลขที่บัญชีราคาสินค้า** (Invoice  Number) ให้ระบุค่าตามจริง กรณีการนำเข้าไม่หมดในครั้งเดียวสามารถใช้เลขที่บัญชีราคาสินค้า ในใบขนสินค้าขาเข้าซ้ำได้อีก

8  **ลำดับรายการในบัญชีราคาสินค้า** (Invoice Item Number) ให้ระบุค่าตามจริง
...
8 **หลักการรวมเอกสาร** **Invoice** **เป็นข้อมูล** **Import Declaration** **Detail**
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbMTA5Mzk3MDgzNiwtMTQ5NzQ5MDIwLC0xOT
