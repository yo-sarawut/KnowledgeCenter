...
ของที่ส่งออกรวมทั้งของที่ส่งกลับออกไป ซึ่งนำกลับเข้ามา**ภายในหนึ่งปี โดยไม่เปลี่ยนแปลงลักษณะหรือรูปแต่ประการใด** และในเวลาที่ส่งออกนั้นได้รับใบสุทธิสำหรับนำกลับเข้ามาแล้ว ได้รับยกเว้นอากร  ให้ผู้ขอยกเว้นอากรจัดทำและส่งข้อมูลใบขนสินค้าขาเข้า โดยระบุค่าดังนี้  
...
กรณีจัดทำ __คำร้องขอรับของไปก่อน__ แทนการจัดทำใบขนสินค้าขาเข้า
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbODEwMjEzMTUxLC03MTMxMzYxNzUsNTE3MT
I5OTk0LC0xMTA4NDIyNDU4LDQ4NzA0MzQwLC0xMjMwNzA2OTYx
XX0=
-->